...
|Reconnaissance, Password Spray, Phishing, Device Code Phishing, Token Abuse, Mailbox Reconnaissance, Persistence, Credential Access, Lateral Movement, Azure Resource Enumeration, Key Vault Access, Secret Exfiltration |[Meridian Health Breach — Password Spray to Key Vault Secret Exfiltration (Phase 1)](Investigations/Meridian-Health-Breach/README.md) | Completed Investigation 
